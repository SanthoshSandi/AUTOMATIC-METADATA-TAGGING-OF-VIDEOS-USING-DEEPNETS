...
train_dataset = h5py.File('./dataset/image_embeddings_to_sentence/stories_to_index_val.hdf5','r')
valid_dataset = h5py.File('./dataset/image_embeddings_to_sentence/stories_to_index_test.hdf5','r') #since training for trainset not yet done
...
cell_type = GRU #GRU FOR LANGUAGE LEARNING
...
#checkpoint_name = "2019-01-19_18-00-46checkpoint_copy.hdf5"
...
writer = ReportWriter('./results/new_model_results1.csv')
